...
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("recipes").id, note_id: User.find_by_username("demo").notes.find_by_title("Authentic Pho Recipe").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("recipes").id, note_id: User.find_by_username("demo").notes.find_by_title("Pasta Primavera").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("recipes").id, note_id: User.find_by_username("demo").notes.find_by_title("Mac N Cheese").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("recipes").id, note_id: User.find_by_username("demo").notes.find_by_title("8 Recipes for Octopus").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("STEM").id, note_id: User.find_by_username("demo").notes.find_by_title("Infinite Square Well").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("STEM").id, note_id: User.find_by_username("demo").notes.find_by_title("Classical Mechanics").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("STEM").id, note_id: User.find_by_username("demo").notes.find_by_title("Day 1: Why take this course?").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("STEM").id, note_id: User.find_by_username("demo").notes.find_by_title("Why Conditionals are Cool: Intro to Bleeding Edge Physics Engine Technology").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("daily").id, note_id: User.find_by_username("demo").notes.find_by_title("Workout 1").id) 
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("daily").id, note_id: User.find_by_username("demo").notes.find_by_title("Workout 2").id) 
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("daily").id, note_id: User.find_by_username("demo").notes.find_by_title("Workout 3").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("daily").id, note_id: User.find_by_username("demo").notes.find_by_title("Grocery List").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("important").id, note_id: User.find_by_username("demo").notes.find_by_title("Grocery List").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("important").id, note_id: User.find_by_username("demo").notes.find_by_title("8 Recipes for Octopus").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("important").id, note_id: User.find_by_username("demo").notes.find_by_title("Recursion").id)
Tagging.create(owner_id: User.find_by_username("demo").id,tag_id: User.find_by_username("demo").tags.find_by_name("important").id, note_id: User.find_by_username("demo").notes.find_by_title("Workout 1").id)
